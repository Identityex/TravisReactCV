                    ...
                    <div className={styles.socialArea}>
                        <div className={styles.social}>
                            <a href={'https://github.com/identityex'} target={'_blank'} rel={'noreferrer'}>
                                <img className={styles.socialImage} src={'/images/github-mark-white.svg'} alt={'Github'} />
                            </a>
                        </div>
                        
                        <div className={styles.social}>
                            <a href={'https://www.linkedin.com/in/travis-arsenault-7113bab0/'} target={'_blank'} rel={'noreferrer'}>
