  ...
  return (
        <Section sectionId={'MyInfo'}>
            <img
                ...
                src="/images/HeadShot.jpeg" alt="Profile Picture" 
            />
            ...
            <div className={styles.contentArea}>
                ...
                <p className={styles.summary}>
                    ...
                    solutions and large-scale system optimizations. Proven track record in reducing operating costs, enhancing
                    system performance, and bolstering security. Adept at mentoring teams and driving innovation, I bring a
